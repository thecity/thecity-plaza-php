...
This PHP library is meant to be used with TheCity (Software to enable communication and community in your church).
...
== Documentation
http://weshays.github.com/thecity-api-php/
